...
void buildHuffmanTree(rav::List<rav::Node *> &lst, const rav::Tree<char, int> &alphabet, rav::NodeComparator comp)
{
...
void decodeAndWrite(const rav::List<rav::Node *>& travers, std::istream &input, std::ostream &output)
{
